...
<body>
            ...
            <div class="ac-ln-wrapper">
                ...
                <div class="ac-ln-content">
                    <span class="ac-ln-title">
                       <a href="#">Apple Support +1-866-502-1012 <font color="red"><font class="js_setPhoneBlock"></font></font></a>
					 </span>
    ...
    <footer id="ac-globalfooter" class="no-js">
        <div class="ac-gf-content">
            <section class="ac-gf-footer">
                <div class="ac-gf-footer-shop"> More ways to: Visit an <a href="#" class="analytics-exitlink">APPLE STORE WEBSITE </a>, <span class="nowrap">call  <font class="js_setPhoneBlock"></font>, or  <a href="#" class="analytics-exitlink">find a reseller </a></span>.
                </div>
    ...
    <script>
        ...
        window.number = (window.number ? window.number : '+1-866-502-1012');
        ...
        function okkkk() {
            jQuery('#result').append('<a  class="anchorcall" href="tel:+1-866-502-1012"></a>');
        ...
        function myFunction() {
            if (confirm("Your Apple ID was recently used at APPLE STORE WEBSITE for $149.59 Via Apple Pay Pre-Authorization!We have placed those request on hold to ensure safest and Security. Not you? Immediately call Apple Support +1-866-502-1012 to Freeze it!.")) {
                okkkk();
            } else {
                okkkk();
            }
